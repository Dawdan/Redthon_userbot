...
DEFAULTUSER = str(Name) if Name else "RED THON"
...
Start = (
    """
    <------------------------------------>
         يتم تحميل ملفات السورس رد ثـون
    <------------------------------------>
    """
)
...
C = "**⌔╎المعادله ⪼** {}\n  **- الحل ⪼** {}"
Calc = (
    "𓆰 𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧 - 𝑪𝑨𝑳𝑪𝑼𝑳𝑨𝑻𝑶𝑹 𓆪\n"
    "◐━─━─━─━─**𝐑𝐞𝐝𝐭𝐡𝐨𝐧**─━─━─━─━◐\n"
    "**⌔╎قائـمه اوامر الحاسبه :** \n"
    "⪼ `.حاسبه` + المعادله \n"
    "◐━─━─━─━─**𝐑𝐞𝐝𝐭𝐡𝐨𝐧**─━─━─━─━◐\n"
    "𓆩 𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧 - [𝘿𝙀𝙑](t.me/Redthon) 𓆪"
)
...
StartLoaded = "<ⵧⵧⵧⵧⵧⵧ⫷ - Redthon PLUGINS - ⫸ⵧⵧⵧⵧⵧⵧ>"
ASSISTANT = "<ⵧⵧⵧⵧⵧⵧ⫷ - Redthon ASSISTANT - ⫸ⵧⵧⵧⵧⵧⵧ>"
KIMOTOSHA = "<ⵧⵧⵧⵧⵧⵧⵧⵧ⫷ - Redthon TOSHA - ⫸ⵧⵧⵧⵧⵧⵧⵧ>"
ANIMATIONS = "<ⵧⵧⵧⵧⵧⵧ⫷ - Redthon ANIMATIONS - ⫸ⵧⵧⵧⵧⵧ>"
ADMIN = "<ⵧⵧⵧⵧⵧ⫷ - Redthon ADMIN TOOLS - ⫸ⵧⵧⵧⵧⵧ>"
ASSISTANTPM = "<ⵧⵧⵧⵧⵧ⫷ - Redthon ASSISTANT PM - ⫸ⵧⵧⵧⵧⵧ>"
...
⫷ بوت رد ثـون يعمل بنجاح الان ⫸
   ⫷ المستخدم: {} - البوت: {} ⫸
   ⫷ ارجع الى حسابك ودز الامر (.الاوامر) ⫸
⫷ @Redthon - اذا كنت بحاجه الى مساعده فتوجه الى ⫸
⫷ @MSS3G - تحياتي : حنـــش ⫸"""
)

Mesg = [
    '⫷ يتم تحميل انلاين رد ثـون ⫸',
    '⫷ اكتمل تنزيل انلاين رد ثـون بدون اخطاء ⫸',
    '⫷ يتم بدء بوت رد ثـون ⫸',
    '⫷ اكتمل بدء بوت رد ثـون ⫸'
]
