...
async def tmgif(zel):
    ...
    if tm_gif:
        zel_c = f"**{TMTE}**\n"
        zel_c += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝐑𝐞𝐝𝐭𝐡𝐨𝐧ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
...
async def tmgif(lon):
    ...
    if tm_gif2:
        ics_c = f"**{TMTE}**\n"
        ics_c += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝐑𝐞𝐝𝐭𝐡𝐨𝐧ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
...
async def tmgif(i):
    ...
    if tm_gif3:
        tumc = f"**{TMTE}**\n"
        tumc += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝐑𝐞𝐝𝐭𝐡𝐨𝐧ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
...
async def tmgif(Redthon):
    if Redthon.fwd_from:
        return
    reply_to_id = await rd(Redthon)
    if tm_gif5:
        tumc = f"**{TMTE}**\n"
        tumc += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝐑𝐞𝐝𝐭𝐡𝐨𝐧ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
        tumc += f"**↫ المتـحركه الخامسه 𓆰.**"
        await Redthon.client.send_file(
            Redthon.chat_id, tm_gif5, caption=tumc, reply_to=reply_to_id
        )
...
async def tmgif(Redthon):
    ...
    if tm_gif7:
        ...
        await Redthon.client.send_file(
            Redthon.chat_id, tm_gif7, caption=tumc, reply_to=reply_to_id
        )
