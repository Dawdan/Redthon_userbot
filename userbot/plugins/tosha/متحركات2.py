...
async def fygif(Redthon):
    if Redthon.fwd_from:
        return
    Ti = await rd(Redthon)
    if fy_gif:
        Redthon_caption = f"**{TSHE}**\n"
        Redthon_caption += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝐑𝐞𝐝𝐭𝐡𝐨𝐧ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
        Redthon_caption += f"**↫ المتـحركه الاولى 𓆰.**"
        await Redthon.client.send_file(
            Redthon.chat_id, fy_gif, caption=Redthon_caption, reply_to=Ti
        )
...
async def fygif(Redthon):
    ...
    if fy_gif2:
        Redthon_caption = f"**{TSHE}**\n"
        Redthon_caption += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝐑𝐞𝐝𝐭𝐡𝐨𝐧ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
        Redthon_caption += f"**↫ المتـحركه الثانيه 𓆰.**"
        await Redthon.client.send_file(
            Redthon.chat_id, fy_gif2, caption=Redthon_caption, reply_to=th
        )
...
async def fygif(Redthon):
    ...
    if fy_gif3:
        Redthon_caption = f"**{TSHE}**\n"
        Redthon_caption += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝐑𝐞𝐝𝐭𝐡𝐨𝐧ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
        Redthon_caption += f"**↫ المتـحركه الثالثه 𓆰.**"
        await Redthon.client.send_file(
            Redthon.chat_id, fy_gif3, caption=Redthon_caption, reply_to=kh
        )
...
async def fygif(Redthon):
    ...
    if fy_gif4:
        fyc = f"**{TSHE}**\n"
        fyc += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝐑𝐞𝐝𝐭𝐡𝐨𝐧ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
        fyc += f"**↫ المتـحركه الرابعه 𓆰.**"
        await Redthon.client.send_file(
            Redthon.chat_id, fy_gif4, caption=fyc, reply_to=wh
        )
...
async def fygif(Redthon):
    ...
    if fy_gif5:
        ...
        await Redthon.client.send_file(
            Redthon.chat_id, fy_gif5, caption=fyc, reply_to=ih
        )
...
async def fygif(Redthon):
    ...
    if fy_gif6:
        ...
        await Redthon.client.send_file(
            Redthon.chat_id, fy_gif6, caption=fyc, reply_to=uh
        )
...
async def fygif(Redthon):
    ...
    if fy_gif7:
        ...
        await Redthon.client.send_file(
            Redthon.chat_id, fy_gif7, caption=fyc, reply_to=oh
        )
