# commands for source Redthon by ~ @MSS3G
...
async def cmds(Redthon):
    await eor(Redthon, Cmds)

########################  SOURCE Redthon ~ BY: MSS3G (@Redthon)  ########################
...
async def _(event):
    ...
    if input_str == "م1":
        ...
        if r == 0:
            await event.edit(
                "𓆰 [𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧  - 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬
](t.me/Redthon) 𓆪\n **⌔╎قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧𝙏𝙃𝙊𝙉](t.me/Redthon) 𓆪"
            )
        else:
            await event.edit(
                "𓆰 [𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧  - 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬
...
########################  SOURCE 𝐑𝐞𝐝𝐭𝐡𝐨𝐧𝙏𝙃𝙊𝙉 ~ BY: MSS3G (@Redthon)  ########################
...
async def _(Redthon):
    await eor(Redthon, "𓆰 [𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/Redthon) 𓆪\n **⌔╎قائـمه اوامر الترحيب :** \n⪼ `.ترحيب ` \n⪼ `.حذف ترحيب ` \n⪼ `.الترحيب `\n 𓆩 [𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧](t.me/Redthon) 𓆪")
...
async def _(Redthon):
    await eor(Redthon, "𓆰 [𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧 - 𝑩𝑳𝑨𝑪𝑲𝑳𝑰𝑺𝑻](t.me/Redthon) 𓆪\n **⌔╎القائمة السوداء :** \n⪼ `.منع كلمه + الكلمه ` لمنع كلمه  \n⪼ `.الغاء منع + الكلمه` \n⪼ `.الكلمات المحظوره` \n⪼ `.ازعاج` \n⪼ `.الغاء ازعاج` \n⪼ `.قائمة الازعاج` \n 𓆩 [𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧](t.me/Redthon) 𓆪")
...
async def _(Redthon):
    await eor(Redthon, "𓆰 [𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧 - 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹](t.me/Redthon) 🧸♥️𓆪\n**𓍹━─━─━─━─𝐑𝐞𝐝𝐭𝐡𝐨𝐧─━─━─━─━𓍻**\n **𓄂**╺  𝑫𝑬𝑽 ❶╰──► @MSS3G ༗\n\n **𓄂**╺  𝑫𝑬𝑽 ❷╰──► @ZBBBBC ༗")
...
async def _(Redthon):
    await eor(Redthon, "𓆰 [𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧  - 𝐃𝐞𝐥𝐞𝐭𝐞](t.me/Redthon) 🗑♻️𓆪\n**𓍹━─━─━─━─𝐑𝐞𝐝𝐭𝐡𝐨𝐧─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
async def Redthon(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    Redthonth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    Redthont = random.choice(mth)
    await edit_or_reply(mention, f"⌔╎نـسـبتكم انـت و [{Redthonth}](tg://user?id={user.id}) هـي {Redthont} 😔🖤")
...
async def Redthon(mention):
    ...
    if not user:
        return
    Redthonth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    Redthont = random.choice(zid)
    await edit_or_reply(mention, f"⌔╎نسبه الانوثه لـ [{Redthonth}](tg://user?id={user.id}) هـي {Redthont} 🤰")
...
async def permalink(mention):
    ...
    Redthonth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    Redthont = random.choice(zid)
    await edit_or_reply(mention, f"⌔╎نسبه الغباء لـ [{Redthonth}](tg://user?id={user.id}) هـي {Redthont} 😂💔")
...
async def permalink(mention):
    ...
    Redthonth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    Redthont = random.choice(zid)
    await edit_or_reply(mention, f"⌔╎نسبة الانحراف لـ [{Redthonth}](tg://user?id={user.id}) هـي {Redthont} 🥵🖤")
...
async def permalink(mention):
    ...
    Redthonth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    Redthont = random.choice(zid)
    await edit_or_reply(mention, f"⌔╎نسبه المثليه لـ [{Redthonth}](tg://user?id={user.id}) هـي {Redthont} 🤡 🏳️‍🌈.")
...
async def permalink(mention):
    ...
    Redthonth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    Redthont = random.choice(zid)
    await edit_or_reply(mention, f"⌔╎نسبه النجاح لـ [{Redthonth}](tg://user?id={user.id}) هـي {Redthont} 🤓.") 
...
async def permalink(mention):
    ...
    Redthonth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    Redthont = random.choice(zid)
    await edit_or_reply(mention, f"⌔╎نسبه الكراهـي لـ [{Redthonth}](tg://user?id={user.id}) هـي {Redthont} 🤮.")
...
async def Redthon(mention):
    ...
    if not user:
        return
    Redthonth2 = user.last_name.replace("\u2060", "") if user.last_name else user.username
    me = await mention.client.get_me()
    my_first = me.first_name
    my_mention = f"[{me.first_name}](tg://user?id={me.id})"
    await edit_or_reply(mention, f"**🚹 ╎ المستخدم ⪼ • ** [{Redthonth2}](tg://user?id={user.id}) \n☑️ **╎ تم رفعـه ورع القـروب .. بنجـاح😹🙇🏻.** \n**🤵‍♂️ ╎ بواسطـه  :** {my_mention} ")
...
async def Redthon(mention):
    ...
    my_first = me.first_name
    my_mention = f"[{me.first_name}](tg://user?id={me.id})"
    await edit_or_reply(mention, f"**🚺 ╎ المستخدمه ⪼ • ** [{Redthonth2}](tg://user?id={user.id}) \n☑️ **╎ تم رفعـها مـزة الكروب .. بنجـاح 🥳💃.** \n**🤵‍♂️ ╎ بواسطـه  :** {my_mention} ")
...
DEFAULTUSER = "Redthon"
CAT_IMG = ""
CUSTOM_ALIVE_TEXT = "𓆩 𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧 - 𝑫𝑬𝑽??𝑳𝑶𝑷𝑬𝑹 𓆪"
EMOJI = "  𓄂† "
...
async def dev(alive):
    ...
    if CAT_IMG:
        ...
        cat_caption += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝐑𝐞𝐝𝐭𝐡𝐨𝐧ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 1 ↬ @MSS3G ༗\n"
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @ZBBBBC ༗\n"
        cat_caption += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝐑𝐞𝐝𝐭𝐡𝐨𝐧ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
        ...
        await edit_or_reply(
            alive,
            f"**{CUSTOM_ALIVE_TEXT}**\n"
            f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝐑𝐞𝐝𝐭𝐡𝐨𝐧ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 1 ↬ @MSS3G ༗\n"
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @ZBBBBC ༗\n"
            f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧ𝐑𝐞𝐝𝐭𝐡𝐨𝐧ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻",
        )
