...
DEFAULTUSERBIO = DEFAULT_BIO or "الحمد الله على كل شئ - @Redthon"
CHANGE_TIME = Config.CHANGE_TIME
DEFAULTUSER = AUTONAME or Config.ALIVE_NAME
RedthonT = Config.CUSTOM_ALIVE_EMRedthon or " "
...
•  **الشـرح •• **__لوضـع بروفايـل وقتـي يتغيـر تلقائيـاً مع حسابـك كل دقيقـه لشرح الامر اذهب الى https://t.me/Redthon_Thon/63 __
  **╮•❐ الامـر ⦂ **`.البايو تلقائي`
•  **الشـرح •• **__لوضـع بايـو وقتـي يتغيـر تلقائـياً مع الوقـت كـل دقيقـه لشرح الامر اذهب الى https://t.me/Redthon_Thon/63 __
