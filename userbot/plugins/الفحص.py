...
@Redthon.on(admin_cmd(outgoing=True, pattern="فحص$"))
@Redthon.on(sudo_cmd(pattern="فحص$", allow_sudo=True))
async def zelzalalive(event):
    ...
    ALIVE_TEXT = Config.CUSTOM_ALIVE_TEXT or "** بـوت  ردثـــﻭن 𝐑𝐀𝐈𝐈𝐒𝙏𝙃𝙊𝙉  يعمـل .. بنجـاح ☑️ 𓆩 **"
...
**{Z_EMOJI} إصـدار ردثـــﻭن :** `{zdver}`
**{Z_EMOJI} إصـدار البـايثون :** `{pyver}`
**{Z_EMOJI} الوقـت :** `{uptime}`
**{Z_EMOJI} المسـتخدم:** {mention}
**{Z_EMOJI} قنـاة السـورس :** [اضغـط هنـا](https://t.me/Redthon)"""
