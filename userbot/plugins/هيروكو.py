...
Heroku_cmd = (
    "𓆰 [𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧 - هيـروكو الفـارات](t.me/Redthon) 𓆪\n"
    "**⌔∮ قائـمه اوامر هيروكو :** \n"
    "⪼ `.ضع فار` + الفار + المتغير\n"
    "⪼ `.جلب فار` + الفار لعرض ما في المتغير \n"
    "⪼ `.حذف فار` + الفار لحذف الفار \n"
    "⪼ `.استخدامي` \n"
    "\n𓆩 [𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧](t.me/Redthon) 𓆪"
)
...
async def variable(var):
    ...
    if exe == "جلب":
        ...
        try:
            ...
            if variable in heroku_var:
                return await ics.edit(
                    "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑹𝑬𝑫𝑻𝑯𝑶𝑵 - 𝑮𝑶𝑵𝑭𝑰𝑮 𝑽𝑨𝑹𝑺 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
        ...
        if variable in heroku_var:
            await ics.edit("**⌔∮ تم تغيـر** `{}` **:**\n **- المتغير :** `{}` \n**- يتم الان اعـادة تشغيـل بـوت رد ثـون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(variable, value))
        else:
        ...
        await ics.edit(f"**⌔∮** `{variable}`  **تم حذفه بنجاح. \n**يتم الان اعـادة تشغيـل بـوت رد ثـون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**")
...
async def _(dyno):
    ...
    try:
        ...
        return await dyno.reply(
            "**- عذرا لا يمكنك استخدام اوامر الفارات وهيروكو الا بعد اضافة كود هيروكو الى الفارات شرح الاضافة [اضغط هنا](https://t.me/Red_Thon)**"
        )
    data = app.get_log()
    await edit_or_reply(
