# for -<*>~ SOURCE Redthon ~<*>- edit By: @Redthon
...
async def Redthon(Redthon):
    mentions = Redthon.text[8:]
    chat = await Redthon.get_input_chat()
    async for x in Redthon.client.iter_participants(chat, 100):
        mentions += f"\n**-** @{x.username} "
    await Redthon.client.send_message(Redthon.chat_id, mentions)
    await Redthon.delete()
@bot.on(admin_cmd(pattern="معرفات 200(?: |$)(.*)"))
@bot.on(sudo_cmd(pattern="معرفات 200(?: |$)(.*)", allow_sudo=True))
async def Redthon(Redthon):
    mentions = Redthon.text[8:]
    chat = await Redthon.get_input_chat()
    async for x in Redthon.client.iter_participants(chat, 200):
        mentions += f"\n**-** @{x.username} "
    await Redthon.client.send_message(Redthon.chat_id, mentions)
    await Redthon.delete()
...
async def Redthon(Redthon):
    mentions = Redthon.text[8:]
    chat = await Redthon.get_input_chat()
    async for x in Redthon.client.iter_participants(chat, 300):
        mentions += f"\n**-** @{x.username} "
    await Redthon.client.send_message(Redthon.chat_id, mentions)
    await Redthon.delete()
...
async def Redthon(Redthon):
    mentions = Redthon.text[8:]
    chat = await Redthon.get_input_chat()
    async for x in Redthon.client.iter_participants(chat, 500):
...
async def Redthon(Redthon):
    mentions = Redthon.text[8:]
    chat = await Redthon.get_input_chat()
    async for x in Redthon.client.iter_participants(chat, 1000):
        mentions += f"- @{x.username} "
    await Redthon.client.send_message(Redthon.chat_id, mentions)
    await Redthon.delete()
...
async def Redthon(Redthon):
    mentions = Redthon.text[8:]
    chat = await Redthon.get_input_chat()
    async for x in Redthon.client.iter_participants(chat, 150):
        mentions += f"\n**𒀭╎**  [{x.first_name}](tg://user?id={x.id}) "
    await Redthon.client.send_message(Redthon.chat_id, mentions)
    await Redthon.delete()
...
async def Redthon(Redthon):
    mentions = Redthon.text[8:]
    chat = await Redthon.get_input_chat()
    async for x in Redthon.client.iter_participants(chat, 50):
        mentions += f"\n**𒀭╎**  [{x.first_name}](tg://user?id={x.id}) "
    await Redthon.client.send_message(Redthon.chat_id, mentions)
    await Redthon.delete()
...
async def Redthon(Redthon):
    mentions = Redthon.text[8:]
    chat = await Redthon.get_input_chat()
    async for x in Redthon.client.iter_participants(chat, 10):
        mentions += f"\n**𒀭╎**  [{x.first_name}](tg://user?id={x.id}) \n"
    await Redthon.client.send_message(Redthon.chat_id, mentions)
    await Redthon.delete()
...
async def get_users(show):
    if show.fwd_from:
        return
    mentions = "𓆩 𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧 𝐆𝐫𝐨𝐮𝐩 𝐓𝐚𝐠𓆪\n**⪼ هييه تعالـو يحبابين**  𓎤: \n"
    reply_to_id = None
...
async def _(event):
    ...
    async for i in bot.iter_participants(event.chat_id):
        ...
        if i.bot:
            ...
            n += 1
    if input_str:
        required_string = """𓆰 𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧  - 𝐆𝐫𝐨𝐮𝐩 𝐒𝐭𝐚𝐭𝐬 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 
...
𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"""
    ...
    await et.edit(
        """𓆰 𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐝𝐭𝐡𝐨𝐧  - 𝐆𝐫𝐨𝐮𝐩 𝐒𝐭𝐚𝐭𝐬 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻
⪼ **العدد ↫ {} **مستخدماً
⪼ **الحسابات المحذوفه ↫** {}
⪼ **اخر ظهور منذ زمن طويل ↫** {}
⪼ **اخر ظهور منذ شهر ↫** {}
