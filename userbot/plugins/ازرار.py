#    Copyright (C) 2020  Redthon
# button post makker for RedThon thanks to uniborg for the base
...
CMD_HELP.update(
    ...
    \n•  **Example :** `.كول + الجمله المراد اظهارها [المطـور]<buttonurl:https://t.me/MSS3G> [رد ثـون]<buttonurl:https://t.me/RedThon> [اوامر السورس]<buttonurl:https://t.me/Red_Thon>`\
    \n\n•  **Syntax : **`.كوول`\
    \n•  **Function :** __Buttons must be in the format as [Name on button]<buttonurl:link you want to open>__\
    \n•  **Example :** `.كوول + الجمله المراد اظهارها [المطـور]<buttonurl:https://t.me/MSS3G> [رد ثـون]<buttonurl:https://t.me/RedThon> [اوامر السورس]<buttonurl:https://t.me/Red_Thon>`\
    "
    }
)
